...
class User extends \Application\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'surname', 'name', 'email', 'username', 'password', 'role');
        }
    ...
    public function setPassword($val = '')
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPassword', array($val));

        return parent::setPassword($val);
    }
    ...
    public function setRole($val = '')
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRole', array($val));

        return parent::setRole($val);
    }
